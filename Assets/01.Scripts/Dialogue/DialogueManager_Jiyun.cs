...
public class DialogueManager_Jiyun : MonoBehaviour //합병 후 DialogueManager_Jiyun -> DialogueManager로 변경
{
    ...
    DialogueUI_Jiyun dialogueUI; //합병 후 DialogueUI_Jiyun -> DialogueUI로 변경
